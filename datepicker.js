...
class DatePicker extends Component {
  constructor(props) {
    ...
    this.onDateMonthPicked = this.onDateMonthPicked.bind(this);
  ...
  onDateMonthPicked({ action, year, month }) {
...
DatePicker.propTypes = {
  mode: PropTypes.oneOf(['date', 'dateMonth', 'datetime', 'time']),
